...
def start_audio(time=5, save_file="/Users/fseff/Desktop/generate_music_web/recording/test.wav"):
...
if st.button('Play'):
        ...
        try:
            audio_file = open(
                '/Users/fseff/Desktop/generate_music_web/recording/test.wav', 'rb')
            audio_bytes = audio_file.read()
            st.audio(audio_bytes, format='audio/wav')
        except:
            st.write("Please record sound first")

# st.subheader("wav/mp3")
# audio_file = st.file_uploader("Upload audio file", type=["wav", "mp3"])
# if audio_file is not None:
#   # To See details
#     # file_details = {"filename": audio_file.name,
#     #                 "filetype": audio_file.type, "filesize": audio_file.size}
      ...
      with st.spinner('处理中...'):
            ...
            def pianoroll_to_midi(y, pianoroll):
                ...
                for i in range(len(onsets)):
                    MyMIDI.addNote(0, 0, int(pianoroll[i][2]),
                                  onsets[i], durations[i], 100)
            ...
            print("Welcome!")
            file_in = '/Users/fseff/Desktop/generate_music_web/recording/test.wav'
            file_out = '/Users/fseff/Desktop/generate_music_web/audio2midi_output/output.mid'
